...
typedef struct job{
	...
	void   (*function)(void* arg, int id);       /* function pointer          */
...
static void* thread_do(void*param);//)struct thread* thread_p);
...
static int thread_init (thpool_* thpool_p, struct thread** thread_p, int id){
	...
	*thread_p = (struct thread*)malloc(sizeof(struct thread));
	...
	pthread_create(&(*thread_p)->pthread, NULL, thread_do, (void*)(*thread_p));
