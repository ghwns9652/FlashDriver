...
bool inf_make_req_buse(char type, KEYT key,KEYT offset,KEYT len,PTR _value,void *_req, void (end_func)(uint32_t,uint32_t,void*));
bool inf_make_req_fromApp(char type, KEYT key,KEYT offset,KEYT len,PTR _value,void *_req, void (end_func)(uint32_t,uint32_t,void*));
