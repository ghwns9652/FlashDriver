...
*/
	...
	bench_add(SEQSET,0,128*1024,128*1024);
	bench_add(SEQGET,0,128*1024,128*1024);
	//bench_add(RANDSET,0,1024*1024,1*1024);
	//bench_add(RANDGET,0,1024*1024,1*1024);
	//bench_add(RANDRW,0,128*1024,1*1024);
